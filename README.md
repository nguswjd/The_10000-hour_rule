...
|사용자 목표 입력 폼|
|:---:|
|<img src="readme-image/main-form.png" width = "450px">|
|사용자의 희망 직업과 하루 훈련 시간을 입력하면,<br> 결과 출력 화면에 해당 내용을 보여줍니다.|

|결과 출력|
|:---:|
|<img src="readme-image/main-result.png" width = "450px">|
...
| `.hidden`     | class | 화면과 스크린리더에 보이지 않는 클래스 |
<br>
...
- 크로스브라우징을 고려한 웹페이지 개발
- (form 제출 방식 지정 및 링크 이동 url 지정)
